        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 sm:gap-12">
            ...
            <div className="md:col-span-6 space-y-4">
              <h3 className="text-xl font-semibold tracking-tight bg-gradient-to-r from-white to-zinc-300 bg-clip-text text-transparent">
                Stay Connected
              </h3>
              ...
              <div className="relative max-w-md">
                <div className="absolute inset-0 bg-gradient-to-r from-violet-500 via-fuchsia-500 to-pink-500 rounded-lg opacity-20">
                  <div className="absolute inset-[1px] rounded-lg bg-black/90" />
                </div>
                <form className="relative flex items-center">
                  <input
                    type="email"
                    placeholder="Enter your email"
                    className="flex-1 bg-transparent text-sm text-zinc-200 placeholder:text-zinc-500 px-4 py-2.5 rounded-l-lg focus:outline-none"
                  />
                  <button
                    type="submit"
                    className="shrink-0 p-2.5 rounded-r-lg bg-gradient-to-r from-violet-500 via-fuchsia-500 to-pink-500 text-white hover:opacity-90 transition-opacity"
                  >
